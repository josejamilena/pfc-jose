...
public class SeleccionarSGBDScript extends javax.swing.JDialog {

    private List<String> lista = null;
    private String hostSGBD = "";

    public SeleccionarSGBDScript(java.awt.Frame parent, List<String> lst, String host) {
        super(parent);
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(josejamilena.pfc.analizador.App.class).getContext().getActionMap(SeleccionarSGBDScript.class, this);
        closeButton.setAction(actionMap.get("closeSelecionarScriptBox")); // NOI18N
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(josejamilena.pfc.analizador.App.class).getContext().getResourceMap(SeleccionarSGBDScript.class);
    ...
    public void cargarGrafica() {
        try {
            GraficoPorSGBD demo = new GraficoPorSGBD(hostSGBD, (String) listaScript.getSelectedItem());
            demo.pack();
