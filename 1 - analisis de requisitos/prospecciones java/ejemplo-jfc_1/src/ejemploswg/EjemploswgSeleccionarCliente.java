...
public class EjemploswgSeleccionarCliente extends javax.swing.JDialog {

    private List<String> lista = null;

    public EjemploswgSeleccionarCliente(java.awt.Frame parent, List<String> lst) {
        super(parent);
        lista = lst;
        initComponents();
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(ejemploswg.EjemploswgApp.class).getContext().getActionMap(EjemploswgSeleccionarCliente.class, this);
        closeButton.setAction(actionMap.get("closeSelecionarScriptBox")); // NOI18N
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ejemploswg.EjemploswgApp.class).getContext().getResourceMap(EjemploswgSeleccionarCliente.class);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGap(6, 6, 6)
                        .addComponent(listaScript, 0, 135, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cargarGrafica, javax.swing.GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE)
                        .addGap(81, 81, 81))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
