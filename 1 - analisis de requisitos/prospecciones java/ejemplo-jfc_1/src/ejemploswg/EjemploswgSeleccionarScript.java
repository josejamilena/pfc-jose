...
public class EjemploswgSeleccionarScript extends javax.swing.JDialog {

    private List<String> lista = null;

    public EjemploswgSeleccionarScript(java.awt.Frame parent, List<String> lst) {
        super(parent);
        lista = lst;
        initComponents();
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(ejemploswg.EjemploswgApp.class).getContext().getActionMap(EjemploswgSeleccionarScript.class, this);
        closeButton.setAction(actionMap.get("closeSelecionarScriptBox")); // NOI18N
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ejemploswg.EjemploswgApp.class).getContext().getResourceMap(EjemploswgSeleccionarScript.class);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGap(6, 6, 6)
                        .addComponent(listaScript, 0, 111, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cargarGrafica, javax.swing.GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE)
                        .addGap(81, 81, 81))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
